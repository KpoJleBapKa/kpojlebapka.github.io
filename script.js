document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            aboutMeText: "I've been using a PC since I was three. Before university, I was mainly interested in PC components and solving technical problems and errors. During my studies, I started to actively develop new skills, including: software development for PCs, mobile devices (Android), game development (for PCs), website development, and bots (Discord, Telegram). Technologies I have worked with: C++, C, C#, HTML/CSS/JS/TS, Java, Kotlin, Git, SQLite, Docker, QT, CMake. My main programming language is C++.",
            skillsTitle: "Skills",
